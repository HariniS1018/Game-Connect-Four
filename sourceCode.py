...
def print_board(board):
  ...
  # to consider the position of index[0][0] as the                            
    last row and first column and position from down                      
    to up -- used numpy here
	...
	for c in range(COLUMN_COUNT - 3):
     	for r in range(ROW_COUNT):
          	if board[r][c] == piece and board[r][c + 1] 
			   == piece and board[r][c + 2] == piece and 
			   board[r][c + 3] == piece:
               	return True
    ...
    for c in range(COLUMN_COUNT):
        for r in range(ROW_COUNT - 3):
            if board[r][c] == piece and board[r + 1][c] == 
			 piece and board[r + 2][c] == piece and 
			 board[r + 3][c] == piece:
               return True
...
def draw_board(board):
    for c in range(COLUMN_COUNT):
        for r in range(ROW_COUNT):
		  pygame.draw.rect(screen, PINK, (c * SQUARESIZE, 
						r * SQUARESIZE + SQUARESIZE, 
						SQUARESIZE, SQUARESIZE))
		  pygame.draw.circle(screen, WHITE, (int(c * 
...
pygame.display.update()
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
          ...
          if turn == 0:
            ...
            turn += 1
            turn = turn % 2  # like odd or even funtion 
						   alternates between zeros
